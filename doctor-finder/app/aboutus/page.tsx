    ...
    return (
        <div className="container max-w-full">
            <div className="mx-4 sm:mx-8 md:mx-16 lg:mx-20 pb-20">
                <h1 className="lg:text-5xl text-4xl pt-10 lg:pt-20 text-black sm:text-left md:text-center lg:text-center font-semibold">About Us</h1>
                <p className="text-black text-lg sm:text-lg md:text-xl lg:text-xl pt-10 lg:mx-20 xl:mx-60 sm:text-left md:text-center lg:text-center">
